...
meson setup build --prefix=$WLD --cross-file aarch64-linux-gnu.txt -Dwayland:documentation=false -Dlibffi:tests=false -Dbuild.pkg_config_path=$WLD/host_dep/lib/x86_64-linux-gnu/pkgconfig 
